...
const heroDetails = {
  theseus: {
    name: "테세우스 (Theseus)",
    overview: {
      birthBackground: "기원전 13세기경 트로이젠 공주 아이트라와 아테네 왕 아이게우스(또는 포세이돈) 사이에서 탄생했습니다. 당시 아티카 지방은 강력한 크레타 미노아 문명에 짓눌려 소년·소녀를 인신공양으로 바쳐야 했고, 산적들이 들끓어 치안이 무너진 야만의 시대였습니다.",
      lifeCurve: [
        { age: "청년기 (16세)", score: 40, event: "바위 밑의 칼과 샌들을 찾고 험난한 육로 모험을 결의" },
        { age: "초기 업적 (18세)", score: 75, event: "코린토스 지협 6대 악당을 소탕하며 아테네에 무용을 떨침" },
        { age: "인생 전성기 (20대)", score: 98, event: "크레타 미궁의 미노타우로스를 격파하고 아티카 연방(시노이키스모스) 통합" },
        { age: "정치 위기 (40대)", score: 55, event: "페이리토오스와의 명분 없는 모험(저승 강림)과 정치적 반발 직면" },
        { age: "말년과 최후 (50대)", score: 15, event: "가문의 비극(파이드라·히폴리토스 참변) 후 스키로스섬에서 암살당함" }
      ],
