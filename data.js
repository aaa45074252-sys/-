  ...
  theseus: [
    {
      ...
      imgUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Th%C3%A9s%C3%A9e_retrouve_l%27%C3%A9p%C3%A9e_de_son_p%C3%A8re_-_Poussin_-_c1638.jpg/800px-Th%C3%A9s%C3%A9e_retrouve_l%27%C3%A9p%C3%A9e_de_son_p%C3%A8re_-_Poussin_-_c1638.jpg",
  ...
  romulus: [
    {
      ...
      desc: "팔라티노 언덕 근처에 버려진 쌍둥이 형제를 암늑대 루파가 젖을 물려 길러낸 로마의 상징입니다."
    },
    {
    ...
    },
    {
      ...
      desc: "로마를 침공한 카이니나의 왕 아크론을 결투로 베고 최초의 최고 전리품을 운반하는 장면입니다."
    },
    {
      title: "사비니 여인들의 중재",
  ...
  lycurgus: [
    {
      ...
      desc: "신탁에 기초해 엄격하고 평등한 군사 국가 스파르타의 헌법을 반포하는 리쿠르고스의 위엄을 그렸습니다."
    },
    {
      title: "신탁을 구하는 리쿠르고스",
      ...
      license: "Public Domain",
      imgUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Eug%C3%A8ne_Delacroix_-_Lycurgus_Consulting_the_Pythia_-_Google_Art_Project.jpg/800px-Eug%C3%A8ne_Delacroix_-_Lycurgus_Consulting_the_Pythia_-_Google_Art_Project.jpg",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Eug%C3%A8ne_Delacroix_-_Lycurgus_Consulting_the_Pythia_-_Google_Art_Project.jpg",
    ...
    },
    {
      ...
      desc: "아고게 훈련 체계에 따라 강인한 신체와 전사 정신을 기르는 스파르타 청년들의 모습입니다."
    },
    {
      ...
      desc: "빈부격차와 사치를 없애기 위해 검소한 음식을 나누어 먹던 규율입니다."
    }
  ],
  numa: [
    {
      ...
      desc: "샘가에서 지혜의 님프 에게리아를 만나 제례와 종교 규율에 관한 영감을 받는 누마의 모습입니다."
    },
    {
      ...
      desc: "누마 왕이 창설하여 로마의 불꽃이 꺼지지 않도록 지키는 순결한 여사제들의 의식입니다."
    },
    {
      ...
      desc: "43년 치세 내내 야누스의 문을 닫아두며 이룩한 태평성대를 기린 그림입니다."
    },
    {
      ...
      desc: "원로원 사절의 추대를 사양하고 은둔을 귀하게 여겼던 순간입니다."
    }
  ],
  solon: [
    {
      ...
      desc: "부유한 왕 크로이소스에게 마지막 죽음 전까지는 행복을 속단할 수 없다고 가르치는 장면입니다."
    },
    {
      title: "솔론의 법전 제정과 연설",
      originalTitle: "Solon",
      ...
      desc: "채무 노예제를 철폐하고 아테네의 새로운 법전을 반포하는 대현자 솔론의 모습입니다."
    },
    {
      ...
      desc: "솔론의 개혁과 민주정의 기틀 위에 번영을 꽃피운 고대 아테네의 풍경입니다."
    },
    {
      title: "아테네 학당의 현자들",
      ...
      desc: "그리스 법치와 철학의 전통 위에 서서 학문을 논하는 사상가들의 모습입니다."
    }
  ],
  publicola: [
    {
      ...
      desc: "비극 앞에서도 공화정의 헌정 질서를 지켜낸 지도자들의 결단을 상징하는 대작입니다."
    },
    {
      ...
      desc: "적장 앞에서 자신의 오른손을 화로에 태우며 굴복하지 않는 기개를 보인 순간입니다."
    },
    {
      ...
      desc: "테베레강을 헤엄쳐 탈출하며 로마의 자유를 지켜낸 영웅적 소녀 클로엘리아의 일화입니다."
    },
    {
      ...
      desc: "도끼를 낮추고 주권이 시민에게 있음을 천명한 푸블리콜라의 입법 원칙이 이어진 로마 의회의 모습입니다."
    }
  ]
};
