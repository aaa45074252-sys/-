...
const allMapEvents = [
  ...
  // [아테네 북쪽] 고대 아고라 광장
  {
    hero: "solon",
    heroName: "솔론",
    title: "아테네 - 고대 아고라 (채무 탕감과 법 제정)",
    desc: "시민들의 빚을 없애고(세이사크테이아) 노예화를 금지하여 아테네 민주주의의 기틀을 확립했습니다.",
    lat: 37.9850, // 아고라 북측으로 분리 (테세우스와 겹침 방지)
    lng: 23.7225
  },
  ...
  // [로마 북동쪽] 퀴리날레 언덕 및 야누스 신전
  {
    hero: "numa",
    heroName: "누마 폼필리우스",
    title: "로마 - 야누스 신전 (평화와 제례)",
    desc: "야누스 신전의 문을 닫고 43년의 재위 동안 단 한 번의 전쟁도 없이 신앙과 법치로 다스렸습니다.",
    lat: 41.9050, // 로마 북동쪽으로 분리
    lng: 12.4950
  },
  // [로마 동쪽] 벨리아 언덕
  {
    ...
    desc: "호화 저택을 스스로 헐고, 집정관의 도끼를 낮추어 시민에게 주권을 돌려주었습니다.",
    lat: 41.8920, // 로마 중앙 동측
    lng: 12.5120
  }
];
